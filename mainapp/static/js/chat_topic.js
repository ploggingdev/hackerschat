$(function() {
    ...
    var chatsock = new ReconnectingWebSocket(ws_scheme + '://' + window.location.host + window.location.pathname + "chat/ws/");
    ...
    //temporarily hardcoded
    var scrollbacksock = new ReconnectingWebSocket(ws_scheme + '://' + window.location.host + window.location.pathname+ "chat/scrollback/");
